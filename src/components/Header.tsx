...
export const Header = ({ children }: Props) => {
  ...
  return (
    <>
      <div className="h-safe-device-top fixed w-full bg-black-main"></div>
      <header className="sticky bg-transparent top-safe-device-top w-full flex justify-center items-center min-h-safe-tg-top"
        ...
        <div ref={divRef} className="text-center font-medium rounded-[8px] bg-accent/20 blur-sm text-accent px-3 py-0.5">
          {children}
        </div>
      </header>
    </>
